...
class BoardContainer extends Component {
    ...
    onClickCell = (x, y, move) => {
        ...
        move.forEach((data) => {
            this.reverseCell(store.getCurrentRoom.board, store.player.chessman, store.opponent.chessman, x, y, data.xx, data.yy);
        });
    ...
    render() {
        ...
        return (
            <BoardView
                ...
                isUpdateBoard={this.isUpdateBoard}
